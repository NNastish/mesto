...
* Запрограммировать на JavaScript открытие и закрытие попапа, редактирование информации на странице, добавление новых карточек, удаление карточек, открытие лайтбокса с фотографией, а еще возможность ставить лайки.
